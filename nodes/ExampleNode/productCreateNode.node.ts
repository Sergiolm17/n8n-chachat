  ...
  description:  INodeTypeDescription = {
    ...
    properties: [
      ...
      },
      {
        ...
        name: 'imageUrl',
        type: 'string',
        default: 'https://cdn.discordapp.com/attachments/942926206033080361/1165452529618923641/Imagen_de_WhatsApp_2023-10-21_a_las_15.15.00_0d964899.jpg?ex=656bd140&is=65595c40&hm=7fe26da7d8c743d4a530f020a2a11ac3d8c2ec4804e955159a7a43a53c6a033f&',
        placeholder: 'Placeholder value',
  ...
  async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
    ...
    for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
      try {
        ...
        const originCountryCode = this.getNodeParameter('originCountryCode', itemIndex, '') as string;
